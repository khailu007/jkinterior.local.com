...
function wedesignshop_custom_post_type(){
    /*
    ...
    register_post_type('desgin_shop', $args); //Tạo post type với slug tên là sanpham và các tham số trong biến $args ở trên

    register_taxonomy('cat_desgin_shop', 'desgin_shop', array(
		'hierarchical' 			=> true,
      ...
      // register_taxonomy('tagdesignshop','desgin_shop', array(
      //   'hierarchical' => false,
      //   'labels' => $labels,
      //   'show_ui' => true,
...
add_action('init', 'wedesignshop_custom_post_type');